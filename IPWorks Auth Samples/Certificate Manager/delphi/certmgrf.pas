...
uses
  ...
  generatecsrf, importcsrf, ipacore, ipatypes, ipacertmgr;
...
procedure TFormCertmgr.ipaCertMgr1CertList(Sender: TObject; CertEncoded: string; CertEncodedB: TArray<System.Byte>;
  const CertSubject, CertIssuer, CertSerialNumber: String;
  HasPrivateKey: Boolean);
var
  listView: TListView;
