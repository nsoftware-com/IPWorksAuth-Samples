...
try:
  ...
  print("Alternatively, leave each prompt blank to use default values for this demo \n")
  ...
  print("The Authorization String will then be set to the 'Authorization' property")
  print("of the JSONS component and used to retrieve the user info for the authenticated client.\n")
